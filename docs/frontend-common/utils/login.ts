...
export function getLoginInfo(): AnyObject {
...
export function handleWeChatLogion(params: LoginParamsForWechat) {
...
export function handleAppLogin(params?: LoginParamsForApp) {
...
export function handlelLoginExpired(config: Dynamic, callback?: () => void) {
...
export function isNonRegisteredUser(): boolean {
  const userInfo = getLoginInfo()
