...
export function handleGlobalError(globalErrorFn, promiseErrorFn) {
...
export function handleRenderError(app, rederErrorFn) {
...
export function handleRequestError(error, source, requestConfig) {
    let errorConfig = {};
    errorConfig = {
